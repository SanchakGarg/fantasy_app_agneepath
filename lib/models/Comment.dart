...
class Comment extends amplify_core.Model {
  ...
  const Comment._internal({required this.id, required post, required content, createdAt, updatedAt}): _post = post, _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
